...
interface ChartApplicationsProps {
  pendingCount: number;
...
const ChartApplications: React.FC<ChartApplicationsProps> = ({
  pendingCount,
  acceptedCount,
  rejectedCount,
  pendingPercentage,
  ...
  const series = [pendingCount, acceptedCount, rejectedCount];
  ...
  return (
    <div className="sm:px-7.5 col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-5">
      ...
      <div className="mb-2">
        <div id="ChartApplications" className="mx-auto flex justify-center">
          <ReactApexChart
            options={options}
            series={series}
            type="donut"
