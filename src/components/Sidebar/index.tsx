...
import Logo from '../../images/logo/nu-logo-2.png';
  ...
  return (
    ...
    >
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-5 py-3 px-4 lg:mt-0 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(_handleClick) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="/"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-dark duration-200 hover:bg-nugold hover:text-white dark:hover:dark:bg-nugold ${
                          (pathname === '/' ||
                            pathname.includes('dashboard')) &&
                          'bg-nugold text-white dark:bg-nugold'
                        }`}
                      >
                        <svg
                          className="fill-current"
              ...
              {/* <!-- Menu Item Dashboard Management --> */}

              {/* <!-- Menu Item Housing Management --> */}
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/housing' || pathname.includes('housing')
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        ...
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-dark duration-200 hover:bg-nugold hover:text-white dark:hover:dark:bg-nugold ${
                          (pathname === '/housing' ||
                            pathname.includes('housing') ||
                            pathname.includes('FormNewBuilding')) &&
                          'bg-nugold text-white dark:bg-nugold'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              ...
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-dark duration-200 ease-in-out hover:text-nugold ' +
                                (isActive && '!text-nugold')
                              }
                            >
                              Buildings
                            </NavLink>
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/incidents' || pathname.includes('incidents')
                }
              >
                {(handleClick, open) => {
                  return (
